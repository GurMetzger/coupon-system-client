...
import "./ViewCustomerCoupons.css";

function ViewCustomerCoupons(): JSX.Element {
        ...
        try {
            ...
            switch (getRequest.getType) {
                case GetCouponsType.All:
                    history.push("/customer/details/coupons", { prevPath: location.pathname });
                    break;
                case GetCouponsType.Category:
                    history.push("/customer/details/coupons?category=" + getRequest.category, { prevPath: location.pathname });
                    break;
                case GetCouponsType.Price:
                    history.push("/customer/details/coupons?maxPrice=" + getRequest.maxPrice, { prevPath: location.pathname });
                    break;
            }
    ...
    return (
        <div className="ViewCustomerCoupons">
...
export default ViewCustomerCoupons;
